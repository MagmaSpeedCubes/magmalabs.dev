(function () {
  // Universal helpers live in core.js (served from the site-data submodule).
  const {
    SITE_DATA_BASE,
    toast,
    copyToClipboard,
  ...
  async function loadProducts() {
    const response = await fetch(`${SITE_DATA_BASE}/products.json`, { cache: "no-store" });
    if (!response.ok) {
  ...
  async function loadPartnerships() {
    const response = await fetch(`${SITE_DATA_BASE}/partnerships.json`, { cache: "no-store" });
    if (!response.ok) {
  ...
  async function loadAwards() {
    const response = await fetch(`${SITE_DATA_BASE}/awards.json`, { cache: "no-store" });
    if (!response.ok) {
  ...
  async function loadTeam() {
    const response = await fetch(`${SITE_DATA_BASE}/team.json`, { cache: "no-store" });
    if (!response.ok) {
  ...
  async function loadBlogPosts() {
    const response = await fetch(`${SITE_DATA_BASE}/blog.json`, { cache: "no-store" });
    if (!response.ok) {
  ...
  async function loadFilms() {
    const res = await fetch(`${SITE_DATA_BASE}/films.json`);
